...
*/
	...
	public Vista() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			 ...
			 */
			//
			//El boton ordena de forma incorrecta la forma correcta es esta {
			//CompareTo-> compareToIgnoreCase
			//Arrays.sort(listaArchivos, Collator.getInstance());
			//Collections.sort(listaArchivos, String.CASE_INSENSITIVE_ORDER);
			//}
